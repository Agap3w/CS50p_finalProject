#creo e aggiungo score, sound effect
...
class MAIN:
    ...
    def draw_score(self):
        ...
        legna_rect = scaled_legna.get_rect(midright = (score_rect.left-10, score_rect.centery)) # creo il rettangolo dalla scaled_legna(surface). midright mi permette di piazzarmi direttamente sul rettangolo adiacente
        score_frame_rect = pygame.Rect(legna_rect.left, legna_rect.top,cell_size+score_rect.width+20, cell_size)
        ...
        screen.blit(scaled_legna, legna_rect) # la legna
...
legna = pygame.image.load("../static/legna.png").convert_alpha()
scaled_legna = pygame.transform.scale(legna, (cell_size, cell_size))
