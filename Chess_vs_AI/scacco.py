...
# helper per creare una square?
# The main game loop's event processing is quite nested, could be simplified by extracting event handlers for each game state
# The game state ("intro", "playing", "outro") could be implemented as an enum. State transitions could be more clearly defined in a dedicated method
...
class GUI:
    ...
    def init_game(self):
        ...
        # Draw initial board
        self.draw_extra("Chess vs AI", "Play")
